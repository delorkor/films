...
<div className={style.headerModal}>Don’t have an account? <Link className={style.headerModalLink} onClick={OpenSignUp}>Sign Up</Link></div>
    ...
    <Input type="text" error={errors.name?.message} className={style.ImputForm} {...register("name")} placeholder="Your name" onChange={()=>{}}></Input>
    </div>
    <div className={style.textEmail}>
        <span className={style.txtLable}>email</span>
    <Input type="text" className={style.ImputForm} error={errors.Email?.message} {...register("email")} placeholder="Your email" onChange={()=>{}}></Input>
    </div>
    <div className={style.textPasword}> <span className={style.txtLable}>Password</span>
    <Input type="pasword" error={errors.Password?.message} className={style.ImputForm} {...register("password")} placeholder="Your password" onChange={()=>{}}></Input>
    </div>
    <div className={style.textPasword}> <span className={style.txtLable}>Confirm  password</span>
    <Input type="pasword" error={errors.Confirm_password?.message} className={style.ImputForm} {...register("Confirm_password")}  placeholder="Confirm  password" onChange={()=>{}}></Input>
    </div>
    <ButtonComp className={style.buttinAuth}>Sign in</ButtonComp>
    <div className={style.headerModal}>Already have an account?  <Link className={style.headerModalLink} onClick={OpenSignUp}>Sign In</Link></div>
    </form>
    </div>
}
